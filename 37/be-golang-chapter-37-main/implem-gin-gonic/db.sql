...
CREATE TABLE shippings (
    ...
    service_type VARCHAR(50) NOT NULL, -- e.g., "Regular", "Express", etc.
    base_cost NUMERIC(10, 2) NOT NULL, -- Basic cost in local currency
    cost_per_km NUMERIC(10, 2) NOT NULL, -- Cost per kilometer
    max_weight_kg NUMERIC(5, 2) NOT NULL, -- Maximum weight allowed in kilograms
    estimated_time TEXT, -- Estimated delivery time description
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    UNIQUE (courier_name, service_type) -- Ensure no duplicate courier-service pair
);


INSERT INTO shippings (courier_name, service_type, base_cost, cost_per_km, max_weight_kg, estimated_time) VALUES
('JNE', 'Regular', 10000, 2000, 30, '3-5 business days'),
('JNE', 'Express', 20000, 2500, 30, '1-2 business days'),
('POS Indonesia', 'Standard', 8000, 1500, 20, '5-7 business days'),
('POS Indonesia', 'Express', 15000, 1800, 20, '2-3 business days'),
('TIKI', 'Economy', 9000, 1800, 25, '4-6 business days'),
('TIKI', 'Express', 18000, 2200, 25, '1-3 business days'),
('J&T', 'Regular', 9000, 1700, 25, '3-5 business days'),
('J&T', 'Express', 19000, 2100, 25, '1-2 business days'),
('Shopee Express', 'Standard', 7000, 1600, 20, '4-6 business days'),
('Shopee Express', 'Next-Day', 14000, 2000, 20, '1-2 business days'),
('Parcel', 'Basic', 8500, 1800, 30, '3-5 business days'),
('Parcel', 'Priority', 17000, 2200, 30, '1-2 business days');
